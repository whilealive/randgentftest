...
\directlua{
  ...
  % TODO: replace by stuff from AussagetestDebug.tex
  local dirlist = { lfs.currentdir() .. sep .. '\Sammelordner' .. sep .. '\Oberthema' .. sep }

  local mixedstatements = collateStatements(dirlist, \AnzahlWahreAussagen, \AnzahlFalscheAussagen)

  printChecklist(mixedstatements)
  printCheckedChecklist(mixedstatements, false)
